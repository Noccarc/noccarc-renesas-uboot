...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"prodsdbootargs=setenv bootargs rw quiet rootwait earlycon root=/dev/mmcblk1p1 \0" \
	"prodemmcbootargs=setenv bootargs rw quite rootwait earlycon root=/dev/mmcblk0p1 \0" \
